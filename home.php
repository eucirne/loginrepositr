...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert_protocolo = "INSERT INTO protocolos (id_protocolo, descricao, data, contribuinte, prazo) VALUES ($next_id, '$descricao', '$data', '$nomeUsuario (ID: $idUsuario)', $prazo)";
